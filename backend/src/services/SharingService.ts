...
export class SharingService {
  ...
  async getSharesForResource(resourceType: ShareableResourceType, resourceId: string): Promise<Entity[]> {
    const db = getAdapter();
   ...
   */
  async getAccessibleResourceIds(userId: string, resourceType: ShareableResourceType): Promise<Set<string>> {
    const db = getAdapter();
  ...
  async canAccessResource(userId: string, resourceType: ShareableResourceType, resourceId: string): Promise<boolean> {
  ...
  async filterAccessible(userId: string, userRole: string, resourceType: ShareableResourceType, entities: Entity[]): Promise<Entity[]> {
