...
export const SCHEMAS: Record<string, SchemaDefinition> = {
  chats: {
    ...
    fields: {
      ...
      webhookId: 'string|null', ownerId: 'string|null', metadata: 'object',
  ...
  knowledge_stores: {
    ...
    fields: {
      ...
      ownerId: 'string|null', metadata: 'object',
      createdAt: 'string (ISO 8601)', updatedAt: 'string (ISO 8601)',
    },
  },
  documents: {
  ...
  users: {
    ...
    fields: {
      ...
      role: '"admin"|"user"', passwordHash: 'string|null', googleId: 'string|null',
      disabled: 'boolean',
      createdAt: 'string (ISO 8601)', updatedAt: 'string (ISO 8601)',
    },
  },
  user_groups: {
    ...
    fields: {
      ...
      memberIds: 'Array<string>', externalId: 'string|null', metadata: 'object',
      createdAt: 'string (ISO 8601)', updatedAt: 'string (ISO 8601)',
    },
  },
  resource_shares: {
    ...
    fields: {
      ...
      resourceId: 'string', targetType: '"user"|"group"', targetId: 'string',
      sharedById: 'string',
